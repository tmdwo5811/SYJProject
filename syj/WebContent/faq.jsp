	...
	<div class="s-content">
		...
		<div class="table1">
			<ol>
				...
				<hr>
				<li>국민청원 게시판에 공개되기 위해서는 '100명의 사전동의'가 필요합니다.
					<ul>
						<li>청원글 작성 완료 시, 여러분에게 ‘사전동의 링크(URL)’가 부여됩니다.</li>
						<li>30일 이내에 여러분의 청원을 지지하는 100명의 사전 동의를 받으셔야 청원게시판에
							청원 내용이 공개되어 더 많은 국민께서 청원에 동참하실 수 있게 됩니다.</li>
						<li>‘사전동의 링크(URL)’를 SNS 등에 공유해 사전 동의를 받아주세요.
							사전 동의는 제공된 ‘사전동의 링크(URL)’를 통해서만 가능합니다.
							100명의 사전 동의를 받은 청원은 관리자의 검토를 거쳐 청원게시판에 공개됩니다.
							단, 국민청원 요건에 맞지 않는 청원은 100명의 동의를 받더라도 게시판에 공개되지 않거나 관리자에 의해 일부 내용이 '숨김' 처리될 수 있습니다.</li>
						<li>‘사전동의 링크(URL)’를 잊으셨거나 등록한 청원 동의 수가 궁금하시다면 
							청와대 홈페이지 > 국민청원 > 내 청원 보기를 통해 확인하실 수 있습니다.</li>
					</ul>
				</li>
				<hr>
			</ol>
