...
<body onload="printClock()">
	...
	<div class="s-content">
			...
			<div class="column large-12 comment-respond">
				...
				<div id="respond">
					...
					<form name="contactForm" id="contactForm" method="post"
						action="loginProc.do" autocomplete="off">
						<fieldset>
		...
		<c:if test="${!empty user_id || !user_id eq 'admin'}">
			<div>
				${user_id} 님 일반계정으로 잘 들어오셨습니다.
				<p>${user_loc} 번 지역의 회원님입니다.
				<div id="comments" class="column large-12">
					<h3 class="h2">우리 동네 실시간 청원</h3>
					<div style="float: right;">
						<button style="height: 40px; line-height: 40px;"
							onclick="location.href='write.html'">지금 청원하기</button>
					</div>
					<!-- START commentlist -->
