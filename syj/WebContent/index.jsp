...
<div class="sidebar_cate">
	<ul>
		<li><a href="#" class="loc_p_li"><span class="i_1 i_11"><i class="fas fa-comments"></i></span> <span class="i_2 i_111">지역별 청원</span></a></li>
		<li><a href="#"><span class="i_1 i_22"><i class="fas fa-gavel"></i></span> <span class="i_2 i_222">답변된 청원</span></a></li>
		<li><a href="#"><span class="i_1 i_33"><i class="fas fa-paper-plane"></i></span> <span class="i_2 i_333">청원 하기</span></a></li>
		<li><a href="#"><span class="i_1 i_44"><i class="fas fa-tree"></i></span> <span class="i_2 i_444">대나무숲</span></a></li>
	</ul>
