		...
		<div class="s-content content">
			...
			<div class="column large-12 comment-respond">
				...
				<div id="respond">
					...
					<h3 class="h2">
						대나무숲<span> 가입 하기</span>
					</h3>

					<form name="contactForm" id="contactForm" method="post"
						action="join_testPro.do" autocomplete="off">
						<input type="hidden" name="" value="">
						<fieldset>

							<div class="form-field">
								<input name="id" id="cName" class="full-width"
									placeholder="사용할 아이디를 입력해주세요." value="" type="text">
							</div>
							<div class="form-field">
								<input name="pw" id="cpassword1" class="full-width"
									placeholder="비밀번호를 입력해주세요." value="" type="password">
							</div>
							<div class="form-field">
								<input name="pw2" id="cpassword2" class="full-width"
									placeholder="비밀번호를 한번더 입력해주세요." value="" type="password">
							</div>

							<div class="form-field">
								<select name="location_no" id="caddress" class="full-width"
									placeholder="거주 지역을 선택해 주세요." value="">
							...
							<div class="form-field">
								<input name="both" id="cBoth1" class="width45 both_input"
									placeholder="주민등록번호 앞 6자리를 입력해주세요." maxlength="6"
									oninput="maxLengthCheck(this)" value="" type="number">
								- <input name="gender" id="cBoth2" class="width45"
									placeholder="주민등록번호 뒤 1자리를 입력해주세요." maxlength="1"
									oninput="maxLengthCheck(this)" value="" type="number">
							</div>
							<div class="form-field">
								<input name="phone" id="cphone" class="full-width"
									placeholder="휴대폰 번호를 입력하세요." maxlength="11"
									oninput="maxLengthCheck(this)" value="" type="number">
							</div>
